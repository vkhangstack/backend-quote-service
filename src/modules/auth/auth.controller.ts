...
export class AuthController {
  ...
  async createRoot(@Body() createRoot: CreateRootDto): Promise<ResponseDto<any> | ResponseDto<string[]>> {
    try {
  ...
  ): Promise<ResponseDto<any> | ResponseDto<string[]>> {
    try {
